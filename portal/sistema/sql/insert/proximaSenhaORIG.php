			...
			if($_GET['valor'] == "proxima"){
				if($aux <= 0){
					...
					if(($_SESSION['ultima_chamada']) != null){
						...
						$sql = "INSERT INTO gerenciamento_painel(senha_atual, status, usuario, tipo_senha)";
						$sql .= " VALUES('".($var200)."', 'Chamada', '".$_SESSION['guiche']."', 'P')";
						...
						$sql3 = "INSERT INTO gerenciamento_painel(senha_atual, status, usuario, tipo_senha)";
						$sql3 .= " VALUES('".($var200)."', 'Chamada', '".$_SESSION['guiche']."', 'P')";
			...
			if($_GET['valor'] == "proxima"){
				if($aux14 <= 0){
					...
					if(($_SESSION['ultima_chamada']) != null){
						...
						$sql = "INSERT INTO gerenciamento_painel(senha_atual, status, usuario, tipo_senha)";
						$sql .= " VALUES('".($var20012)."', 'Chamada', '".$_SESSION['guiche']."', 'C')";
						mysql_query($sql) or die(mysql_error());
						...
						$sql3 = "INSERT INTO gerenciamento_painel(senha_atual, status, usuario, tipo_senha)";
						$sql3 .= " VALUES('".($var20012)."', 'Chamada', '".$_SESSION['guiche']."', 'C')";
						mysql_query($sql3) or die(mysql_error());
